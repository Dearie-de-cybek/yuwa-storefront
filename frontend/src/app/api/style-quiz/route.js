...
// GET /api/style-quiz?occasion=WEDDING&mood=ELEGANT&silhouette=FLOWING&material=silk — public
export async function GET(request) {
  const { occasion, mood, silhouette, material } = queryParams(request);
  const result = await styleQuizService.recommend({ occasion, mood, silhouette, material });
